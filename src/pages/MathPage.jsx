...
import { MathSectionComponent, LessonGridComponent, QuestionComponent, BreadcrumbComponent, VideoComponent,} from "../components/monhoc/LayoutToan";
...
function MathPage() {
  ...
  const {
    ...
    fetchLessonsByTopic,
    progressMap,
  } = useMathApi(selectedClass, selectedSubject, activeLesson, selectedLevel);

  const lessonLogic = useLessonLogic({
    selectedClass,
    selectedSubject,
    activeTopic,
    activeLesson,
